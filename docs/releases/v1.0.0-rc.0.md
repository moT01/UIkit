...
Archived note: this file is historical release-draft material. Use
[`docs/releasing.md`](../releasing.md) for the current release runbook.
...
The major-bump marker changeset used during this draft was
`.changeset/major-v1-0-0-rc-0.md`. That planning file is not part of the
current release control plane.
